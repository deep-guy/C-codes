...
size_t Truck :: mass() const {
  std :: cout << "Truck mass() called" << std :: endl ;
  return _mass ;
}
...
Truck const & Truck::operator=(Truck const &other) {
  return *this ;
}

Truck const & Truck::operator=(Vehicle const &other) {
  return *this ;
}

// MiniTruck implementation //
MiniTruck :: MiniTruck() {}

MiniTruck :: MiniTruck(size_t tractor_mass, size_t trailer_mass,
		       size_t speed, std :: string brand):
  Truck(tractor_mass,trailer_mass,speed,brand) {
  
}

MiniTruck :: ~MiniTruck() {
  std :: cout << "MiniTruck destructor called" << std :: endl ;
}

// size_t MiniTruck :: mass() const {
//   std :: cout << "MiniTruck mass() called" << std :: endl ;
//   return (2000) ;
// }
